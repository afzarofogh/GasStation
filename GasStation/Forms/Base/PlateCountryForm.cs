...
{
    public partial class PlateCountryForm : General.SuperForm
    {
        #region Variables
		...
		void deleteMenu_Click (object sender, EventArgs e)
		{
			...
			{ 
				...
				Common.BLL.Entity.GasStation.Base__PlateCountry		model	= new Common.BLL.Entity.GasStation.Base__PlateCountry ()
				{
					id	= id
				};
				...
				CommandResult	opResult	= lPlateCountry.delete (model);
        ...
        void modifyMenu_Click(object sender, EventArgs e)
        {
			...
			{ 
				...
				PlateCountryEntryForm	form	= new PlateCountryEntryForm (model);
        ...
        {
			PlateCountryEntryForm form	= new PlateCountryEntryForm ();
		...
		void reload ()
		{
			...
			CommandResult opResult	= lPlateCountry.allData ("", "country", false);
