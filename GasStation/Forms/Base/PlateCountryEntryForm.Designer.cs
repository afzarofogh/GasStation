...
{
	partial class PlateCountryEntryForm
	{
		/// <summary>
		...
		private void InitializeComponent ()
		{
			...
			this.dataGroupBox.Controls.Add(this.countryTextBox);
			...
			this.countryTextBox.Location = new System.Drawing.Point(29, 58);
			...
			this.countryTextBox.Tag = "country";
			// 
			// label1
			// 
			...
			this.Name = "PlateCountryEntryForm";
			this.Text = "ثبت اطلاعات / کشور";
