...
{
    public partial class OwnerTypeForm : General.SuperForm
    {
        #region Variables
		...
		void deleteMenu_Click (object sender, EventArgs e)
		{
			...
			{ 
				...
				Common.BLL.Entity.GasStation.Base__OwnerType	model	= new Common.BLL.Entity.GasStation.Base__OwnerType ()
				{
					id	= id
				};
				...
				CommandResult	opResult	= lOwnerType.delete (model);
        ...
        void modifyMenu_Click(object sender, EventArgs e)
        {
			...
			{ 
				...
				Common.BLL.Entity.GasStation.Base__OwnerType	model	= new Common.BLL.Entity.GasStation.Base__OwnerType ()
				{
			 	...
			 	OwnerTypeEntryForm	form	= new OwnerTypeEntryForm (model);
        ...
        {
			OwnerTypeEntryForm form	= new OwnerTypeEntryForm ();
		...
		void reload ()
		{
			...
			CommandResult opResult	= lOwnerType.allData ("", "type", false);
