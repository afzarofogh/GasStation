...
{
	partial class CarLevelEntryForm
	{
		/// <summary>
		...
		private void InitializeComponent ()
		{
			...
			this.dataGroupBox.Controls.Add(this.levelTextBox);
			...
			this.levelTextBox.Location = new System.Drawing.Point(29, 58);
			this.levelTextBox.MaxLength = 50;
			this.levelTextBox.Name = "levelTextBox";
			this.levelTextBox.Size = new System.Drawing.Size(298, 26);
			this.levelTextBox.TabIndex = 0;
			this.levelTextBox.Tag = "levelcar";
			// 
			// label1
			// 
			...
			this.Name = "CarLevelEntryForm";
			this.Text = "ثبت اطلاعات / تیپ خودرو";
