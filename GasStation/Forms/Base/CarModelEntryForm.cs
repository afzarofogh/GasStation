...
{
	public partial class CarModelEntryForm : General.SuperForm
	{
		#region Variables
		/// <summary>
		/// Model
		/// </summary>
		Common.BLL.Entity.GasStation.Base__CarModel		model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public CarModelEntryForm (Common.BLL.Entity.GasStation.Base__CarModel model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.GasStation.Base__CarModel ();
			else
			{
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.GasStation.Base__CarModel>.fillControl (dataGroupBox, model);
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.GasStation.Base__CarModel>.fillModel (dataGroupBox, model);
